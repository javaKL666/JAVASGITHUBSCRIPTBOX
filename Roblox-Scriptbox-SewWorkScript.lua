...
local function SendChatMessage(message) if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
local textChannel = TextChatService.TextChannels.RBXGeneral textChannel:SendAsync(message) else ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(message, "All") end end SendChatMessage("欢迎使用工脚本")
...
about:Toggle("自瞄(总开关)", "开关", false, function(v)
    toggleAiming(v)
end)
...
about:Button("甩飞被选中的人", function()
    ...
    if not TargetPlayer or TargetPlayer == Player then
        game:GetService("CoreGui"):SetCore("SendNotification", {Title = "工脚本", Text = "无玩家可甩飞", Duration = 2, Icon = "rbxassetid://114514"})
        return
    end

    local Message = function(_Title, _Text, Time)
        game:GetService("CoreGui"):SetCore("SendNotification", {Title = _Title, Text = _Text, Duration = Time, Icon = "rbxassetid://114514"})
    end
...
game:GetService("CoreGui"):SetCore("SendNotification", {Title = "工脚本", Text = "目标处于坐姿", Duration = 2, Icon = "rbxassetid://114514"})
isRunning = false
return
end
if not TCharacter:FindFirstChildWhichIsA("BasePart") then
game:GetService("CoreGui"):SetCore("SendNotification", {Title = "工脚本", Text = "玩家已趋势", Duration = 2, Icon = "rbxassetid://114514"})
isRunning = false
return
end
...
about:Button("甩飞所有人", function()
    ...
    local Message = function(_Title, _Text, Time)
        game:GetService("CoreGui"):SetCore("SendNotification", {Title = _Title, Text = _Text, Duration = Time, Icon = "rbxassetid://131499184387795"})
    end
...
local CountDown26 = about:Label("27")
...
local about = NaturalDisasterSurvival:section("请到自然灾害服务器执行工脚本",true) 
about:Label("尊敬的工脚本用户您好")
about:Label("请您进入自然灾害服务器执行工脚本")
about:Label("即可显示自然灾害服务器功能")